...
fn_past = os.path.join(basepath, 'raw_data', 'tasmax_day_era5.nc')
fn_current = os.path.join(basepath, 'raw_data', 'tasmax_day_reanalysis_era5_r1i1p1_20240101-20241231.nc')
